...
const JsonSchemaBuilder: React.FC = () => {
  const { control, handleSubmit, watch } = useForm<SchemaFormData>({
    defaultValues: {
      fields: [
        {
          id: '1',
  ...
  const onSubmit = (data: SchemaFormData) => {
    ...
    console.log('Generated JSON:', generateJsonFromSchema(data.fields));
  };
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="text-center mt-8">
            <button
              type="submit"
              className="px-8 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-lg hover:from-emerald-700 hover:to-teal-700 transition-all duration-200 shadow-lg hover:shadow-xl"
            >
              Export Schema
            </button>
          </div>
